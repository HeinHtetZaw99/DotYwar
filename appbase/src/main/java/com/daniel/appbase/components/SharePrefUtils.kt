...
class SharePrefUtils private constructor(private val context: Context) {
    ...
    enum class KEYS(val label: Int, val defaultValue: String) {
        TOKEN(R.string.SP_TOKEN, ""),
        USER_NAME(R.string.SP_USER_NAME , ""),
        PHONE_NUMBER(R.string.SP_PHONE_NUMBER , ""),
        ADDRESS(R.string.SP_ADDRESS , ""),
        PROFESSION(R.string.SP_PROFESSION , ""),


    }

    enum class KEYB(val label: Int, val defaultValue: Boolean){
        HAS_LOGIN(R.string.SP_LOGIN , false),
    }
